...
Object cadr(Object l) { return car(l, 1); }

Object cddr(Object l) { return cdr(l, 1); }
...
bool is_static(Object obj) { return (API::is_static(obj)); }

Env get_closure(Object obj) { return (API::get_closure(obj)); }

void set_closure(Object obj, Env env) { API::set_closure(obj, env); }

/********** Display functions **********/

void rplacd(Object l, Object new_value) { API::rplacd(l, new_value); }
...
void print_stats() { API::print_stats(); }
