...
bool subrp(Object obj) {
  ...
  return ((obj_s == lisp_plus) || (obj_s == lisp_times) ||
          (obj_s == lisp_minus) || (obj_s == lisp_eq) || (obj_s == lisp_inf) ||
          (obj_s == lisp_concat) || (obj_s == lisp_numberp) ||
          (obj_s == lisp_stringp) || (obj_s == lisp_symbolp) ||
          (obj_s == lisp_listp) || (obj_s == lisp_nullp) ||
          (obj_s == lisp_newline) || (obj_s == lisp_car) ||
          (obj_s == lisp_cdr) || (obj_s == lisp_cons));
}
