...
Object do_concat(Object lvals) { return do_concat_aux(lvals, true); }
...
Object do_nullp(Object lvals) { return bool_to_object(null(car(lvals))); }

Object do_stringp(Object lvals) { return bool_to_object(stringp(car(lvals))); }

Object do_numberp(Object lvals) { return bool_to_object(numberp(car(lvals))); }

Object do_symbolp(Object lvals) { return bool_to_object(symbolp(car(lvals))); }

Object do_listp(Object lvals) { return bool_to_object(listp(car(lvals))); }
...
Env do_define(Object lvals, Env env) {
  ...
  if (!symbolp(car(lvals)) && !listp(car(lvals))) {
    toplevel_error(
        "Cannot define it: first element must be a symbol or a list");
  }
  Object value;
  std::string name;
  if (listp(car(lvals))) {
...
Object do_lambda(Object lvals) { return lvals; }
...
Object do_read() { return read_object(); }
...
bool do_debug(Object l) { return (object_to_bool(car(l))); }

bool do_stats(Object l) { return (object_to_bool(car(l))); }
