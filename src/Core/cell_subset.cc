...
int Cell_number::get_number_of_cells() { return number_of_cells; }

// Garbage collection

void Cell_number::mark_used() { Collectable::used = true; }
...
int Cell_string::get_number_of_cells() { return number_of_cells; }

// Garbage collection

void Cell_string::mark_used() { Collectable::used = true; }
...
int Cell_symbol::get_number_of_cells() { return number_of_cells; }

// Garbage collection

void Cell_symbol::mark_used() { Collectable::used = true; }
...
void Cell_pair::set_cdr(Cell *new_cdr) { cdr = new_cdr; }

// Stats

int Cell_pair::get_number_of_cells() { return number_of_cells; }
